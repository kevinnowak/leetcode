package com.github.kevinnowak.maven.wincent;
...
public class Solution {
    ...
    static TestInput getTestInputFromFileName(final String fileName) {
        ...
        try (Scanner scanner = new Scanner(file)) {
            ...
            for (int i = 0; i < testInput.getNumberOfGames() && scanner.hasNextLine(); i++) {
                ...
                if (scanner.hasNextLine()) {
                    game.setCurrentDirection(
                            Direction.valueOf(scanner.nextLine().trim().toUpperCase()));
                }
    ...
    public static void main(String[] args) {
        TestInput testInput =
                getTestInputFromFileName("src/main/java/com/github/kevinnowak/wincent/input");
