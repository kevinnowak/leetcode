package com.github.kevinnowak.leetcode.top_150.array_string._13_roman_to_integer;
...
class Solution {
    ...
    public int romanToInt(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if (secondCharacter != '\u0000'
                    && romanToIntMap.containsKey(
                            firstCharacter + String.valueOf(secondCharacter))) {
