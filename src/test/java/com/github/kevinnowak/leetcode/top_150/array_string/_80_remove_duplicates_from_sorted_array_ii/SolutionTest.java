package com.github.kevinnowak.leetcode.top_150.array_string._80_remove_duplicates_from_sorted_array_ii;
...
class SolutionTest {
    ...
    private static Stream<Arguments> provideDataForRestRemoveDuplicates() {
        return Stream.of(
                ...
                Arguments.of(
                        new int[] {0, 0, 1, 1, 1, 1, 2, 3, 3}, 7, new int[] {0, 0, 1, 1, 2, 3, 3}));
    }
